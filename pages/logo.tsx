...
function AutoShuffleApp() {
  ...
  return (
    <FlipProvider>
      ...
      <div className="relative flex w-full h-full justify-center items-center bg-gray-800">
        <div data-flip-root-id={todoItemsId} className="w-300">
          {components}
        </div>
        <div className="absolute w-300">
          <div
            className={`text-white font-bold flex justify-center items-center text-2xl w-32 h-32 m-2 rounded-lg inline-block`}
          >
            F
          </div>
          <div
